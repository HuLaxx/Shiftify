  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <GlowOrb color="accent" size="lg" className="top-[-15%] left-[-10%]" delay={0} />
        <GlowOrb color="secondary" size="md" className="bottom-[5%] right-[-10%]" delay={1} />
      </div>

      <div className="relative z-10 pt-8 pb-12 px-4 max-w-6xl mx-auto">
        <TopNav />
