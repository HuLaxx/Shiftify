  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <GlowOrb color="secondary" size="lg" className="top-[-20%] right-[-15%]" delay={0} />
        <GlowOrb color="primary" size="md" className="bottom-[10%] left-[-10%]" delay={1.5} />
      </div>
      ...
      <div className="relative z-10 pt-8 pb-12 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="space-y-6">
            <Card variant="elevated" className="p-0 overflow-hidden flex flex-col h-[calc(100vh-140px)]">
              {/* Toolbar */}
